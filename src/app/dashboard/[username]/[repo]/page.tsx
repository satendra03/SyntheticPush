...
const Repo = () => {
  ...
  return (
    <div className="container py-10 mx-auto min-h-[70vh] flex items-center justify-center">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 w-full max-w-5xl">
        {/* Disclaimer Card */}
        <div className="order-2 lg:order-1 w-full rounded-2xl shadow-xl p-8 border backdrop-blur-md h-fit">
          <h2 className="text-2xl font-bold mb-4 text-center">Disclaimer</h2>
          <div className="text-center space-y-4 mb-8">
            <p className="font-semibold text-yellow-500">
              ⚠️ You are about to make a GitHub push.
            </p>
            <p>
          ...
          <Button
            variant={know ? "secondary" : "destructive"}
            className="w-full font-bold"
            onClick={() => setKnow(true)}
            disabled={know}
          >
            {know ? "Acknowledged" : "I know, I'm aware"}
          </Button>
        </div>

        {/* Date Selector Card */}
        <div className="order-1 lg:order-2 w-full rounded-2xl shadow-xl p-8 border backdrop-blur-md">
          <h2 className="text-2xl font-bold mb-2 text-center">Date Selector</h2>
          <p className="text-muted-foreground mb-8 text-center text-sm">
            Select a mode and provide the required date(s) to do the work!!!
            data.
          </p>
